...
function logWithTime() {
    ...
    console.log.apply(console, __spreadArrays([format(new Date(), "MM-DD-YYYY HH:mm:ss")], args));
}
var WorkerOld = /** @class */ (function (_super) {
    __extends(WorkerOld, _super);
    function WorkerOld() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    WorkerOld.prototype.run = function () {
        ...
        var rClient = redis.createClient({ db: 15 });
