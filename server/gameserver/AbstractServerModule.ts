...
import { AppAuthToken } from "mrdario-core/api";
import { authAndValidateRequest, SocketResponder, validateRequest } from "./utils/index.js";
import {
...
import { LegacyCompatServer, LegacyCompatSocket, ServerModuleOptions } from "./compat.js";

export abstract class AbstractServerModule {
  scServer: LegacyCompatServer;
  rClient: ServerModuleOptions["rClient"];
  ...
  public abstract handleConnect(socket: LegacyCompatSocket): void;
