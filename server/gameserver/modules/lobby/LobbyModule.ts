...
import { AbstractServerModule, makeChannelConfig, ModuleConfig } from "../../AbstractServerModule.js";
import { bindSocketHandlers, EventHandlersObj, hasAuthToken, logWithTime, unbindSocketHandlers } from "../../utils/index.js";
...
export class LobbyModule extends AbstractServerModule {
  ...
  protected leaveLobby(socket: LegacyCompatSocket): void {
