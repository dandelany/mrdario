      ...
      if (gamepads.nonstandardEventsEnabled) {
        ...
        window.addEventListener('gamepadbuttondown', (e) => {
          ...
          if(button === 0 || button === 4) {
            this.handleInput(INPUTS.RotateCCW, 'keydown', e);
          } else if(button === 1) {
            this.handleInput(INPUTS.RotateCW, 'keydown', e);
          }
        });
        ...
        window.addEventListener('gamepadbuttonup', (e) => {
          ...
          const {button} = e;
          if(button === 0 || button === 4) {
            this.handleInput(INPUTS.RotateCCW, 'keyup', e);
          } else if(button === 1) {
            this.handleInput(INPUTS.RotateCW, 'keyup', e);
          }
        });
      }
    }
